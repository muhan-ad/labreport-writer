...
本项目由 **慕寒** 与 **宇宙创生** 联合开发完成。项目核心架构设计、用户界面实现及整体技术方案规划由慕寒（QQ：1323889125）负责开发与调试；宇宙创生（QQ：2383412126）提供了西安电子科技大学物理实验课程知识库、基于 Word COM 接口的报告自动生成脚本，以及对策府库的实验数据集。

本项目的实验数据资源得益于对策府库开源社区的贡献，在此向对策府库全体贡献者致以诚挚的谢意，感谢其在实验数据共享与开源精神方面所做出的努力。

如对本项目有任何疑问、建议或合作意向，欢迎通过以下方式联系：**慕寒**（1323889125@qq.com）。
