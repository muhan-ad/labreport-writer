...
def _generate_docx(data: dict, output_path: str):
    ...
    delta_Ki_disp = f"{delta_Ki:.1f}"
    delta_Rg_disp = f"{delta_Rg:.1f}"
...
def main():
    ...
    DOCX_FILE = os.path.join(SCRIPT_DIR, "灵敏电流计特性测量实验报告.docx")
